                ...
                <div class="panel-heading">Data Pelapor</div>
                    <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('namaperusahaan') ? ' has-error' : '' }}">
                            <label for="namaperusahaan" class="col-md-4 control-label">Nama Perusahaan:</label>

                            <div class="col-md-6">
                                <input id="namaperusahaan" type="text" class="form-control" name="namaperusahaan" value="{{ old('namaperusahaan') }}" required autofocus>
                        ...
                        <div class="col-md-6">
                                <input id="role" type="hidden" class="form-control" name="role" value="kontraktor" readonly>
                        </div>
                        </div>
